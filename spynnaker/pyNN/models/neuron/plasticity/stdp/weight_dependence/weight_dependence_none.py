...
class WeightDependenceNone(AbstractWeightDependence):
    ...
    def is_same_as(self, weight_dependence):
        if not isinstance(weight_dependence, WeightDependenceNone):
            return False
        return (
    ...
    def get_parameters_sdram_usage_in_bytes(
        ...
        if n_weight_terms == 1:
            ...
            raise NotImplementedError(
                "No weight dependence only supports one or two terms")
